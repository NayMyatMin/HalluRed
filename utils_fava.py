...
def get_fava_data(n_samples=1000):
    ...
    processed_path = "processed_fava_text.json"
    if not os.path.exists(processed_path):
        raise FileNotFoundError(
            "processed_fava_text.json not found at repo root. Prepare it from https://huggingface.co/datasets/fava-uw/fava-data as described in README, and place it at the project root."
        )
