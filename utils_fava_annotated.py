...
def get_modified_data():
    ...
    if not os.path.exists(annotations_path):
        raise FileNotFoundError(
            "annotations.json not found at repo root. Download from https://huggingface.co/datasets/fava-uw/fava-data/blob/main/annotations.json and place it at the project root."
        )
